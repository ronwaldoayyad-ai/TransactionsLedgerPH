...
// Build the payment-due summary from the exact set of installments being summed
// (web paymentDueSummary port). `focusDate` is the most recent due date "to
// date"; if every date is in the future, it's the earliest one.
